...
module.exports = {
  env: {
    ...
    NEXT_EXAMPLE_SUPABASE_URL: process.env.NEXT_EXAMPLE_SUPABASE_URL,
    NEXT_EXAMPLE_SUPABASE_CLIENT_KEY: process.env.NEXT_EXAMPLE_SUPABASE_CLIENT_KEY,
    NEXT_EXAMPLE_SUPABASE_SERVICE_KEY: process.env.NEXT_EXAMPLE_SUPABASE_SERVICE_KEY,
    NEXT_EXAMPLE_CAT_API_KEY: process.env.NEXT_EXAMPLE_CAT_API_KEY
  },
}
